...
export default function Technology() {
  return (
    <section id="technologies" className="flex bg-[#3871ff] justify-between items-center px-[10%] m-auto min-h-[80%] z-0">
      ...
      <article className="grid grid-cols-2 gap-14 pr-[15%] text-white">
