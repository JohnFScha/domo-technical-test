...
export default function Technology() {
  return (
    <section id="technologies" className="flex bg-[#3871ff] justify-between items-center px-[10%] m-auto FHD:min-h-[70%] HD-1:min-h-[100%] IOS:max-h-[60%] IOS:pt-[5%] HD-1:pt-[20%] WXGA-2:min-h-[100%] WXGA-2:pt-[10%] z-0">
