...
export default function Home() {
  return (
    <section id="home" className="flex items-center max-w-[50%] mr-auto ml-[11%] FHD:min-h-[80%] HD-1:min-h-[72%] pb-[10%]">
      <article className="flex flex-col gap-5">
        ...
        <div className="flex gap-5 mt-3">
          <Link href={'#about'} className="btn btn-outline rounded-none">Learn more</Link>
